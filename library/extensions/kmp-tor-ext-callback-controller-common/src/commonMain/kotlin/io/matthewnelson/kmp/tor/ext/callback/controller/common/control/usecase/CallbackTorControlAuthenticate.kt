 ...
 *
 * https://torproject.gitlab.io/torspec/control-spec/#authenticate
 * */
interface CallbackTorControlAuthenticate {

    fun authenticate(bytes: ByteArray, callback: RequestCallback<Any?>): Task
