 ...
 *
 * Any usage of a declaration annotated with [InternalTorApi]
 ...
 *
 *   -Xopt-in=io.matthewnelson.kmp.tor.common.annotation.InternalTorApi
 * */
@RequiresOptIn
@MustBeDocumented
@Target(
...
annotation class InternalTorApi
