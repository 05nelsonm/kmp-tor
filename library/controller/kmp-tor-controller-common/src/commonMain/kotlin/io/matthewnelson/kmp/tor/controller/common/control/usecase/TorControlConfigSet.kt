 ...
 * */
interface TorControlConfigSet {

    suspend fun configSet(setting: TorConfig.Setting<*>): Result<Any?>

    suspend fun configSet(settings: Set<TorConfig.Setting<*>>): Result<Any?>
