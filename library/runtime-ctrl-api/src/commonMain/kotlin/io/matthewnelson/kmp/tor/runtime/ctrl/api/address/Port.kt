 ...
 *
 * @see [Proxy]
 * @see [io.matthewnelson.kmp.tor.runtime.ctrl.api.util.isAvailable]
 * @see [io.matthewnelson.kmp.tor.runtime.ctrl.api.util.isAvailableAsync]
 * */
public open class Port private constructor(
     ...
     * @see [io.matthewnelson.kmp.tor.runtime.ctrl.api.util.isAvailable]
     * @see [io.matthewnelson.kmp.tor.runtime.ctrl.api.util.isAvailableAsync]
     * @see [io.matthewnelson.kmp.tor.runtime.ctrl.api.util.findAvailable]
     * @see [io.matthewnelson.kmp.tor.runtime.ctrl.api.util.findAvailableAsync]
     * */
