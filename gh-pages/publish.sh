...
trap 'rm -rf "$DIR_SCRIPT/kmp-tor"' EXIT

cd "$DIR_SCRIPT"
git clone -b gh-pages --single-branch https://github.com/05nelsonm/kmp-tor.git
rm -rf "$DIR_SCRIPT/kmp-tor/"*
echo "kmp-tor.matthewnelson.io" > "$DIR_SCRIPT/kmp-tor/CNAME"
